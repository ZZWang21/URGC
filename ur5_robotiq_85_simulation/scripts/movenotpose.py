...
class MoveItCartesianPath:
    def __init__(self):
        ...
        target_position = [0.35, 0.35, 0.20]
        ...
        # zzw 20230513 Create an orientation constraint object
        orientation_constraint = OrientationConstraint()
        orientation_constraint.header.frame_id = "base_link"
        orientation_constraint.link_name = end_effector_link
        orientation_constraint.orientation.x = start_pose.orientation.x#0.0
        ...
        self.arm.set_position_target(target_position, end_effector_link)
        #self.arm.set_pose_target(target_pose)
        #self.arm.set_max_velocity_scaling_factor(0.5) #ZZW SPEED
        ...
        for i in range(len(trajectory_msg.points)):
            print("Waypoint", i, "time stamp:", trajectory_msg.points[i].time_from_start.to_sec())
